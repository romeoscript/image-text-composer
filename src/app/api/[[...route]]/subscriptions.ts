...
const app = new Hono()
  // Billing endpoint disabled - no authentication required
  ...
  // })
  // Current subscription endpoint disabled - no authentication required
  ...
  //   });
  // })
  // Checkout endpoint disabled - no authentication required
